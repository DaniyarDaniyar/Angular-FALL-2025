function runA1() {
    ...
    Rectangle.prototype.describe = function(){
        const d = Shape.prototype.describe.call(this);
        return d + " Rectangle " + this.width + 'x' + this.height;
    };
    ...
    Square.prototype.describe = function(){ 
        const d = Rectangle.prototype.describe.call(this)
        return d + " Square side=" + this.side 
     };
